...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      >
        {/* Student Login Toggle - Top Right */}
        <div style={{
          ...
          <button
            ...
            style={{
              padding: '6px 12px',
              borderRadius: '8px',
              border: mode === 'admin' ? '2px solid white' : '1px solid rgba(255,255,255,0.3)',
              background: mode === 'admin' ? 'rgba(255,255,255,0.25)' : 'transparent',
              color: 'white',
              cursor: 'pointer',
              fontSize: '12px',
          ...
          <button
            ...
            style={{
              padding: '6px 12px',
              borderRadius: '8px',
              border: mode === 'student' ? '2px solid white' : '1px solid rgba(255,255,255,0.3)',
              background: mode === 'student' ? 'rgba(255,255,255,0.25)' : 'transparent',
              color: 'white',
              cursor: 'pointer',
              fontSize: '12px',
        ...
        <p style={{
          ...
          {mode === 'admin'
            ...
            : 'View your audit results and submit requests'
          }
        </p>
